...
object OakHoeItem {
  def apply: CustomHoeItem = new CustomHoeItem(OakToolMaterial, OakToolMaterial.getAttackDamage.asInstanceOf[Int], 1.0F, new Item.Settings().group(ItemGroup.TOOLS))
  def identifier(id: String): Identifier = new Identifier(id, "oak_hoe")
